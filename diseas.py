...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("D:\Projects\Training.csv\Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("D:\Projects\Testing.csv")
...
w2 = Label(root, justify=LEFT, text="By Harshita Chauhan", fg="#2F4F4F", bg="#D8BFD8")
